...
-- while Google shows closed). The unified "Rikasta ravintolat" admin job
-- (enrich-restaurants-all) fetches Google hours via DataForSEO in the same
-- my_business_info call, converts them to an OSM-format string, and stores them
-- here; /api/restaurants prefers these over OSM.
--
