...
function activityToCandidate(a: Activity, rating?: { rating: number; reviewCount: number }): Candidate {
  const ACT_CAT_WEIGHT: Record<ActivityCategory, number> = {
    ...
    // pubivisa: sama paino kuin kirpputorilla — kelpo löytö, ei kärkinosto
    sauna: 5, nakopaikka: 5, uimaranta: 4, galleria: 4, markkina: 4, kirpputori: 4, pubivisa: 4, museo: 3, nahtavyys: 2, puisto: 1, urheilu: 0.5, muu: 1,
  }
