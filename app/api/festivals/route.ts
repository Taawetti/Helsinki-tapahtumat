...
// Static festival data — fallback when Supabase is not configured
// When Supabase is set up, all data lives there and this list is bypassed
...
function fromDb(row: DbFestival): FestivalDef {
  return {
    id: row.id,
    name: row.name,
...
export async function GET(req: NextRequest) {
  ...
  let festivals: FestivalDef[] = FESTIVALS_2026
